...
and may remove, edit, or reject comments, commits, issues, pull requests, or
...
[GitHub's report abuse flow](https://support.github.com/contact/report-abuse)
and identify this repository. Do not open a public issue about a private conduct
incident. Reports will be reviewed as promptly and fairly as practical, and the
privacy and security of reporters will be respected.

Community leaders will apply proportionate consequences, ranging from a private
correction or warning to a temporary or permanent ban, based on the severity
and pattern of the behavior.
