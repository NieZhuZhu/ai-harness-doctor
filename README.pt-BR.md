...
- Artefatos e relatórios eval ocultam credenciais de alta confiança em diagnósticos runner/judge, metadata usage aninhada e templates matrix; preservam usage numérico e a avaliação usa em memória a saída original limitada.
