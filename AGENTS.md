...
- The release workflow must self-test the tagged Action before npm publish, derive/move/verify the matching floating major Action tag after publish, preserve older major tags, and create the Marketplace confirmation reminder. Never suppress these failures with `|| true`.
