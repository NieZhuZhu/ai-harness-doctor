...
- Eval gates verify current task/effective-evidence before health. Task-declared sources bind automatically; explicit sources compose; files hash bytes, directories bind type only. Refresh changed committed results honestly.
