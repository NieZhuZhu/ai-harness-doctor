...
- Eval 결과 artifact와 report는 runner/judge 진단, nested usage metadata, matrix runner template의 신뢰도 높은 credential을 redacted 처리합니다. Numeric usage는 유지되며 grading은 메모리의 원본 bounded output을 사용합니다.
