...
| 安全 | 明文 secret（AWS、GitHub、OpenAI、Anthropic、Google、OpenRouter、Groq、xAI、Perplexity、HuggingFace、GitLab、npm、PyPI、Slack、Stripe 凭据和 JWT）、过宽权限、不安全 MCP transport、危险 hook 以及权限绕过指引。 |
