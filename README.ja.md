...
- Eval result artifact と report は runner/judge diagnostics、nested usage metadata、matrix runner template の高信頼 credential を redact します。Numeric usage は保持され、grading は memory 内の元の bounded output を使用します。
