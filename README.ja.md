...
| Security | Plaintext secrets（AWS、GitHub、OpenAI、Anthropic、Google、OpenRouter、Groq、xAI、Perplexity、HuggingFace、GitLab、npm、PyPI、Slack、Stripe 資格情報と JWT）、広すぎる権限、安全でない MCP transport、危険な hook、権限 bypass 指示。 |
