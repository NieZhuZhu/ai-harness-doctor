...
- **Hallazgos en los que puedes confiar.** 37 rondas de validación registradas contra repositorios reales han producido trece correcciones de falsos positivos (openai/codex, microsoft/vscode, cline, gemini-cli, …), cada una publicada con tests de regresión; las clases aplazadas se registran abiertamente en lugar de ocultarse — [registro de validación externa](EXTERNAL_VALIDATION.md).
